            ...
            <div className="hidden md:flex items-center gap-12 flex-shrink-0">
              ...
              <Link to="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
                ...
                <span className="text-white font-black text-lg tracking-tight leading-none">
                  Sakura<span style={{ color: '#ff4da6' }}>Flix</span>
                </span>
              </Link>
                ...
                {navLinks.map((link) => (
                  <Link
                    ...
                    className={`relative px-6 py-2 text-sm font-bold uppercase tracking-wider transition-all skew-x-[-12deg] border-l-2 border-transparent hover:border-brand-400 hover:bg-brand-400/10 ${
                      isActive(link.path) ? 'text-brand-400 border-brand-400 bg-brand-400/10 shadow-[inset_0_0_10px_rgba(255,77,166,0.2)]' : 'text-zinc-400 hover:text-white'
                    }`}
                  >
            ...
            <div className="flex items-center gap-2 md:gap-6 flex-shrink-0 ml-auto md:ml-0">
              ...
              <div className="hidden md:flex items-center gap-6">
                ...
                <button className="text-zinc-400 hover:text-brand-400 transition-colors relative group">
                    ...
                    <span className="absolute -top-1 -right-1 w-2 h-2 bg-brand-400 rounded-none rotate-45 shadow-[0_0_5px_#ff4da6]" />
                </button>
                ...
                {user ? (
                  ...
                  <Link to="/login" className="flex items-center gap-2 bg-brand-400 hover:bg-white text-black px-6 py-2 text-xs font-black uppercase tracking-widest transition-all skew-x-[-12deg] clip-path-polygon hover:scale-105 shadow-[0_0_15px_rgba(255,77,166,0.4)]">
        ...
        {isMobileOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 w-[85%] max-w-sm bg-black border-l-2 border-brand-400 z-50 lg:hidden shadow-[0_0_50px_rgba(255,77,166,0.3)] overflow-y-auto"
            >
              <div className="p-6 relative">
                ...
                <div className="flex items-center justify-between mb-8 border-b border-white/10 pb-4">
                  <div className="flex items-center gap-2">
                    <img src="/logo.jpg" alt="SakuraFlix" className="w-8 h-8 rounded-full object-cover" />
                    <span className="text-white font-black text-lg tracking-tight">Sakura<span style={{ color: '#ff4da6' }}>Flix</span></span>
                  </div>
                  <button 
                    onClick={() => setIsMobileOpen(false)}
                ...
                <div className="space-y-1">
                    <div className="text-[10px] font-bold text-brand-400 uppercase tracking-widest mb-4 opacity-70 border-b border-brand-400/20 pb-1">🌸 Browse</div>
                ...
                <div className="mt-8 pt-8 border-t border-white/5 space-y-2">
                    <div className="text-[10px] font-bold text-brand-400 uppercase tracking-widest mb-4 opacity-70 border-b border-brand-400/20 pb-1">SakuraFlix Info</div>
                ...
                <div className="mt-12 p-4 bg-brand-400/10 border border-brand-400/30 rounded-none skew-x-[-5deg]">
                    <div className="flex items-center justify-center gap-2">
                        <img src="/logo.jpg" alt="SakuraFlix" className="w-5 h-5 rounded-full object-cover skew-x-[5deg]" />
                        <p className="text-brand-400 text-xs font-bold uppercase tracking-widest text-center flex items-center gap-2 skew-x-[5deg]">
                            <span className="w-2 h-2 bg-brand-400 rounded-full animate-pulse shadow-[0_0_5px_#ff4da6]"></span>
                            SakuraFlix Online
                        </p>
                    </div>
                </div>
