...
const ScheduleCard: React.FC<{ item: ScheduleItem, index: number, isLast: boolean }> = ({ item, index, isLast }) => {
    return (
        ...
        >
            ...
            {/* Timeline Dot */}
            <div className="absolute left-[6px] md:left-[10px] top-1.5 w-3 h-3 rounded-full bg-dark-950 border-2 border-brand-400 z-10 shadow-[0_0_10px_rgba(244,114,182,0.5)] group-hover:scale-125 transition-transform" />
